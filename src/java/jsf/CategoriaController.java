...
public class CategoriaController implements Serializable {
    ...
    @EJB
    private jpa.session.CategoriaFacade ejbFacade;
    private PaginationHelper pagination;
    private int selectedItemIndex;
    
    private final List<SelectItem> listaCategorias = new ArrayList<SelectItem>();
    ...
    public List<SelectItem> listaDeCategorias(){
        List<Categoria> categorias = getFacade().findAll();
        listaCategorias.clear();
        
        for (int i = 0; i < categorias.size(); i++) {
            listaCategorias.add(new SelectItem(categorias.get(i), categorias.get(i).getNombre()));
        }
