...
import jpa.session.CiudadFacade;
...
public class CiudadController implements Serializable {
    ...
    @EJB
    private jpa.session.CiudadFacade ejbFacade;
    ...
    public List<Ciudad> getCiudadPorProvincia(Provincia provincia){
        
        listaCiudad = ejbFacade.getByProvincia(provincia);
